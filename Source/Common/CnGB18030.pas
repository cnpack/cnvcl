...
*
*           四字节：（不包括和中国无关的其他语言字符，因此分隔区对应的 Unicode 编码可能是其他语言的字符）
*
...
*           8336BE37~8430BA31            分隔区十五（ 含部分 BMP 的 PUA 区）    4995                D7A4 到 FB4F，不连续，比如 8336C738 = D7FF 和 8336C739 = E76C
...
*
*  FD308130~FE39FE39             用户自定义区，共 25200 个码位，目前无 Unicode 映射，与 Unicode 的扩展俩 PUA 区 F0000~FFFFD 以及 100000~10FFFD 也不重叠
*
