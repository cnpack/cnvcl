...
*               实现大数范围内的基础 Schoof 算法并初步小范围测试通过，大范围无从验证
*           2020.10.25 V1.6
...
begin
  ...
  try
    ...
    T2 := TCnBigNumberRationalPolynomial.Create;
    ...
    Result := BigNumberRationalPolynomialEqual(RL, RR);       // 比较是否相等
  finally
...
begin
  ...
  try
    ...
    T1 := TCnBigNumberRationalPolynomial.Create;
    T2 := TCnBigNumberRationalPolynomial.Create;
