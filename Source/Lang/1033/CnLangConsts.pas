...
* 单元标识：$Id: CnLangConsts.pas,v 1.16 2009/01/02 08:27:39 liuxiao Exp $
...
resourcestring
  ...
  SCnactCollectFormCaption = 'Generate All';
  ...
  SCnactDelBlankCaption = 'Delete Blank';
  SCnactDelBlankHint = 'Delete All the Blank Strings';
  SCnactDelLineCaption = 'Delete Line';
