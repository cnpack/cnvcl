...
* 单元标识：$Id: CnTwain.pas,v 1.3 2009/01/02 08:27:39 liuxiao Exp $
...
begin
  ...
  repeat
    ...
    setup.VRefNum := 0;
    hF := OpenFile(PAnsiChar(string(setup.Filename)), ofs, OF_CREATE);
      ...
      case twRC of
        TWRC_XFERDONE:
          begin
            ...
            hF := OpenFile(PAnsiChar(string(setup.FileName)), ofs, OF_READ);
            hbm_acq := 0;
