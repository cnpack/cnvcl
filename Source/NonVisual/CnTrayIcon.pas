...
* 单元标识：$Id: CnTrayIcon.pas,v 1.10 2009/01/02 08:27:39 liuxiao Exp $
...
begin
  ...
  begin
    ...
    StrPLCopy(FIconXP.szInfoTitle, Title, SizeOf(FIconXP.szInfoTitle) - 1);
    StrPLCopy(FIconXP.szInfo, Value, SizeOf(FIconXP.szInfo) - 1);
