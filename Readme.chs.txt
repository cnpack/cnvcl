...
======================================================================
    ...
    开发包支持 Delphi 5/6/7/2005/2006/2007/2009/2010/XE/XE2/XE3/XE4/XE5/XE6
/XE7 和 C++Builder 5/6。用户需要在 IDE 中打开 Packages 目录下的包文件（注
意版本号），再在包文件窗口中进行编译安装。其中带 dcl 前缀的为设计期包，无
此前缀的为运行期包。注意应该先编译运行期包，再安装设计期包。
