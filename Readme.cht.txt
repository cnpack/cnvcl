**********************************************************************
                   ...
                   中國人自己的開放源碼第三方開發包
                 (C)Copyright 2001-2010 CnPack 開發組
**********************************************************************
...
======================================================================
    ...
    開發包支持 Delphi 5/6/7/2005/2006/2007/2009/2010 和 C++Builder 5/6。
用戶需要在 IDE 中打開 Packages 目錄下的包文件（注意版本號），再在包文件
窗口中進行編譯安裝。其中帶 dcl 前綴的為設計期包，無此前綴的為運行期包。
注意應該先編譯運行期包，再安裝設計期包。
