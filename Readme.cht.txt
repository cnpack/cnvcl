**********************************************************************
                   ...
                   中國人自己的開放源碼第三方開發包
                 (C)Copyright 2001-2017 CnPack 開發組
**********************************************************************
...
XE6/XE7/XE8/10 Seattle/10.1 Berlin 和 C++Builder 5/6。用戶需要在 IDE 中
打開 Packages目錄下的包文件（注意版本號），再在包文件窗口中進行編譯安裝。
其中帶 dcl 前綴的為設計期包，無此前綴的為運行期包。注意應該先編譯運行期包，
再安裝設計期包。
