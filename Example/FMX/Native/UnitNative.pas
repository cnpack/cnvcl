...
uses
  ...
  FMX.StdCtrls, CnNative, FMX.ExtCtrls,  SysConst, FMX.Edit, FMX.Memo, FMX.Types, System.Types, System.UITypes;
...
begin
  A8 := 45;
  B8 := 247;
  ConstTimeConditionalSwap8(chkSwap.IsChecked, A8, B8);
  mmoRes.Lines.Add(Format('%d, %d', [A8, B8]));

  A16 := 4502;
  B16 := 24701;
  ConstTimeConditionalSwap16(chkSwap.IsChecked, A16, B16);
  mmoRes.Lines.Add(Format('%d, %d', [A16, B16]));

  A32 := 45020001;
  B32 := 247010002;
  ConstTimeConditionalSwap32(chkSwap.IsChecked, A32, B32);
  mmoRes.Lines.Add(Format('%d, %d', [A32, B32]));

  A64 := 4502000199999283434;
  B64 := 4701000299999283434;
  ConstTimeConditionalSwap64(chkSwap.IsChecked, A64, B64);
