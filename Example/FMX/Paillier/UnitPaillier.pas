...
uses
  ...
  FMX.StdCtrls, FMX.ExtCtrls, CnBigNumber, CnPaillier, FMX.Edit, FMX.Memo, FMX.TabControl, FMX.Types,
  FMX.ScrollBox, FMX.Controls.Presentation;

type
  TFormPaillier = class(TForm)
    pgcPaillier: TTabControl;
    tsInt64Paillier: TTabItem;
