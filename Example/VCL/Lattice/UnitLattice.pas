...
begin
  ...
  begin
    case FMLDSA.MLDSAType of
      cmdt44:
        FMLDSA.GenerateKeys(FMLDSAPriv, FMLDSAPub, 'D71361C000F9A7BC99DFB425BCB6BB27C32C36AB444FF3708B2D93B4E66D5B5B');
      cmdt65:
        FMLDSA.GenerateKeys(FMLDSAPriv, FMLDSAPub, '1BD67DC782B2958E189E315C040DD1F64C8AB232A6A170E1A7A52C33F10851B1');
      cmdt87:
        FMLDSA.GenerateKeys(FMLDSAPriv, FMLDSAPub, 'F7052FBB921759CD8716773BA6355630121D6927899FDDA5768E2BC240FCCB7B');
    end;
  end
  else
...
begin
  ...
  if FMLDSA.VerifyBytes(FMLDSAPub, Sig, MSG, '', cmhtNone) then
    ShowMessage('Verify OK')
  else
    ShowMessage('Verify Fail');
end;
