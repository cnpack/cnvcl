...
- **杂凑**：SM3、MD5、SHA1、SHA2/SHA3 系列（192、256、384、512）、SHAKE、CRC8/16/32/64、Poly1305、FNV、一次性杂凑签名算法
...
- **运算支持**：浮点复数运算、位运算、矩阵运算、离散傅立叶变换、128 位整型支持
...
cncrypto\Test 目录下有一完整的命令行测试用例 CryptoTest.dpr，使用任一版本 Delphi 打开运行即可覆盖验证 CnPack 密码算法库的绝大多数功能。尾部两个用例耗时较长以小时计，跑时需有耐心。
